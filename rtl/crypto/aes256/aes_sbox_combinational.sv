//==============================================================================
// aes_sbox_combinational.sv
// AES S-box implemented as a 256-entry ROM using a combinational case —
// explicit to avoid sharing with any other lookup in the design.
//==============================================================================
